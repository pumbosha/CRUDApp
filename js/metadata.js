var metadata = [
    ...
    },
    {
        ...
        "validations": {"required":true, "min":"01-01-2010", "max":"10-01-2010", "pattern":	"^(?:(?:31(-)(?:0?[13578]|1[02]))\\1|(?:(?:29|30)(-)(?:0?[1,3-9]|1[0-2])\\2))(?:(?:19|20)?\\d{2})$|^(?:29(-)0?2\\3(?:(?:(?:19|20)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00))))$|^(?:0?[1-9]|1\\d|2[0-8])(-)(?:(?:0?[1-9])|(?:1[0-2]))\\4(?:(?:19|20)?\\d{2})$"},
    ...
    },
    {
        ...
        "assignParams": {},
        "validations": {"required":true, "pattern":"^.*(`record.name.replace('T', 'y|u')`|`record.surname`).*$"},
