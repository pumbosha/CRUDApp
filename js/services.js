...
app.factory('formService', function(utilService) {
	return {
		...
		updateModelChbx: function(field, id) {
			for (var i in field) {
				if (field[i]==id) {
					field.splice(i, 1);
					return;
...
app.factory('daoService', function(utilService) {
	return {
		records: [
			{"name":"Tomasz", "surname":"Wilk", "pesel":"88021405057", "dateOfBirth":"14-02-1988", "salary":1000, "sex":"male", 'pseudonym':'Wilku', 'interestings':['football', 'politicans'], 'vehicle':'car', 'advantages':['smart', 'conscientious'], 'dateOfAffiliating':'12-02-2008'},
			{"name":"Maria", "surname":"Nowak", "pesel":"92121265498", "dateOfBirth":"12-12-1998", "salary":1500, "sex":"female", 'pseudonym':'MariaSkłodowska', 'interestings':['football', 'poetry'], 'vehicle':'bike', 'advantages':['smart'], 'dateOfAffiliating':'02-12-2010'},
			{"name":"Mirosław", "surname":"Kowalski", "pesel":"75100912398", "dateOfBirth":"09-10-1975", "salary":750, "sex":"male", 'pseudonym':'Kowalskij', 'interestings':['politicans'], 'vehicle':'motorbike', 'advantages':['punctual', 'conscientious'], 'dateOfAffiliating':'03-05-2009'},
			{"name":"Marek", "surname":"Bielski", "pesel":"69021585394", "dateOfBirth":"15-02-1969", "salary":1250, "sex":"male", 'pseudonym':'Bielskis', 'interestings':[], 'vehicle':'train', 'advantages':['smart', 'conscientious', 'punctual'], 'dateOfAffiliating':'17-09-2016'},
			{"name":"Anna", "surname":"Stępień", "pesel":"80061985263", "dateOfBirth":"19-06-1980", "salary":500, "sex":"female", 'pseudonym':'Hanna', 'interestings':['football', 'politicans', 'poetry'], 'vehicle':'', 'advantages':['punctual'], 'dateOfAffiliating':'13-06-2012'},
			{"name":"Roman", "surname":"Bełski", "pesel":"87091874965", "dateOfBirth":"18-09-1987", "salary":2000, "sex":"male", 'pseudonym':'Romanov', 'interestings':['football'], 'vehicle':'car', 'advantages':'', 'dateOfAffiliating':'27-08-2013'}
		],
