	...
	return {
		getErrorMessages: function() {
			return {
                ...
                'advantages': {'required':'Dont you have any advantages?', 'pattern': 'nie taki patter (brak -s-)'}
			};
		},
		...
		getValidations: function() {
			return {
                ...
                'advantages' : {'required':true, 'pattern':'^.*s|S.*$'}
			}
		},
		getAvailableOpts: function() {
			return {
				'vehicle': [{'id':'car', 'name':'Car'}, {'id':'train', 'name':'Train'}, {'id':'bike', 'name':'Bike'}, {'id':'motorbike', 'name':'Motorike'}],
                'advantages': [{'id':'punctual', 'name':'Punctual'}, {'id':'conscientious', 'name':'Conscientious'}, {'id':'smart', 'name':'Smart'}],
                'sex': [{'id':'male', 'name':'Male'}, {'id':'female', 'name':'Female'}]
			}
		}
	}
});
